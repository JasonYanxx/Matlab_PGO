function [alpha_overbound,gama_overbound,epsilon_achieved,intervals]= stable_overbound(sample_data,epsilon, Nbins, NstepsCdf)
...
NstepsCdf=10000;
gama_overbound = find_gama(halfBinEdge, halfSymCdf, NstepsCdf)
alpha_overbound = find_alpha(halfBinEdge, halfSymCdf, NstepsCdf,gama_overbound)
% alpha_overbound=1
