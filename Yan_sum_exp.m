...
pdf_pgo=pdf_tgo;cdf_pgo=cdf_tgo;
...
%     ts_fft=0;
%     for j=1:10
%         [pdf_convfft,ts_fft_all]=YanFun.selfConv_fft(x_lin,pdf_pgo,num_conv);
...
%     ts=0;
%     for j=1:10
%         [pdf_conv,ts_all]=YanFun.selfConv(x_lin,pdf_pgo,num_conv);
%         ts=ts+ts_all;
%     end
...
% YanFun.compareConvOverbound(x_lin,pdf_pgo,pdf_emp,num_conv)
...
% [FA_Bayes_max,MD_Bayes_max]=YanFun.FDE_BayesGMM(alpha,seed,num,gmm_dist,bias,"max-seperate");
% [FA_Bayes_sum,MD_Bayes_sum]=YanFun.FDE_BayesGMM(alpha,seed,num,gmm_dist,bias,"sum-seperate");
% 
